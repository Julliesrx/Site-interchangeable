...
<body>
    ...
    <main>
        <h1><?php echo $type; ?></h1>
        <?php
        foreach ($meilleurs['recette'] as $nom => $details) {
            echo "<h2>$nom</h2>"; ?>
            ...
            <div class="grid-container">
                ...
                <div class="text-content">
                    ...
                    <p>
                        <?php
                        foreach ($details['Ingrédients'] as $ingredient => $quantite) {
                    ...
                    <p>
                        <?php
                        foreach ($details['Préparation'] as $etape => $description) {
                            echo "$etape : $description <br>";
                        }
                        ?>
                    </p>
                </div>
