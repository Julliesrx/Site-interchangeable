...
<body>
    ...
    <main>
        <h1><?php echo $type; ?></h1>
        <?php
        foreach ($meilleurs['destinations'] as $nom => $details) {
            echo "<h2>$nom</h2>"; ?>
            ...
            <div class="grid-container">
                ...
                <div class="text-content">
                    ...
                    <p>
                        <?php
                        foreach ($details['Attractions'] as $attraction => $description) {
                            echo "$attraction : $description <br>";
                        }
                        ?>
                    </p>
                    <h3>Conseils :</h3>
                    <p>
                        <?php
                        foreach ($details['Conseils'] as $conseil => $description) {
                            echo "$conseil : $description <br>";
                        }
                        ?>
                    </p>
                </div>
